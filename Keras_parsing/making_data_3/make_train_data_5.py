# @Author: J.Y.
# @Date:   2019-05-28T10:37:26+09:00
# @Project: NLP
# @Last modified by:   J.Y.
# @Last modified time: 2019-05-28T10:40:47+09:00
# @License: JeeY
# @Copyright: J.Y. JeeY
...
def write_new_divided_train_data(filenum, sents):
    fname = fpath + 'parsing_BiLSTM_train_data_%02d.train' %filenum
    with open(fname, 'a', encoding='utf-8') as fw:
        for line in sents:
            fw.write('  '.join(line) + '\n')

trainfile1 = 'd:/Program_Data/raw_train_dataset_24.train'
