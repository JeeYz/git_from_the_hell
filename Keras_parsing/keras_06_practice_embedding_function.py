...
# @Last modified time: 2019-04-02T14:44:50+09:00
# @License: JeeY
# @Copyright: J.Y. JeeY
...
embedding_layer1 = layers.Embedding(len(words_matrix)+1,
                            W_VEC_SIZE,
                            embeddings_initializer=Constant(words_matrix),
                            input_length=MAX_SEQUENCE_LENGTH)(sequence_input1)

embedding_layer2 = layers.Embedding(P_VEC_SIZE,
                            P_VEC_SIZE,
                            embeddings_initializer=Constant(pos_matrix),
                            input_length=MAX_SEQUENCE_LENGTH)(sequence_input2)
...
network = Model([sequence_input1, sequence_input2], output_layer)
network.summary()
