# @Author: J.Y.
# @Date:   2019-04-12T06:07:59+09:00
# @Last modified by:   J.Y.
# @Last modified time: 2019-04-12T06:55:03+09:00
# @License: J.Y. JeeYz
# @Copyright: J.Y. JeeYz
...
filename3 = 'd:/Program_Data/raw_train_dataset_10.train'
    ...
    for k,i in enumerate(full_data):
        ...
        for m,n in enumerate(i):
            if m == 0 or m == 1:
                ...
                # del one_data
                one_train_input.append(one_data)
        ...
        temp = list()
        # print(one_train_input)
        for w,z in enumerate(one_train_input):
            if len(z) != 18:
                print(z)
                time.sleep(100000)
            z.append(one_train_label[w])
            line = '\t##\t'.join(z)
            temp.append(line)
        # for y in temp:
        #     print(y)
