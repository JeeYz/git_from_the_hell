...
# mod
sp4000_5 = '../../traindata/LSTM/0_1_LSTM_train_sp4_f_down.txt'
sp4000_6 = '../../traindata/LSTM/0_2_LSTM_train_sp4_f_down.txt'
...
#%% input layer   
    ...
    #%% output layer
    # x = layers.TimeDistributed(layers.Dense(128, activation='sigmoid'))(x)
