...
# @Last modified time: 2018-11-22T16:00:22+09:00
# @Copyright: JayY
...
word_dict = make_dict_data(filename04)
...
generate_train_data(word_dict, filename05, filename06)
...
dividing_full_train_data_file(filename06, dir_path01)
